...
import nurseangel.TargetMark.proxy.CommonProxy;
...
public class TargetMark {
	...
	private void addTargetMarkBlock() {
		...
		BlockTargetMark.setBlockName("BlockTargetMark").setCreativeTab(CreativeTabs.tabRedstone);
		...
		BlockTargetMarkLighting.setBlockName("BlockTargetMarkLighting");
